...
if(isset($_POST['sub1'])){
  $date=$_POST['semday1'];
 $count=$db->addnewStudentTerm('1',$id_student,$date,$_SESSION['email']);
...
if(isset($_POST['sub2'])){
  echo "2";
   $date=$_POST['semday2'];
 $count=$db->addnewStudentTerm('2',$id_student,$date,$_SESSION['email']);
...
if(isset($_POST['sub3'])){
   $date=$_POST['semday3'];
 $count=$db->addnewStudentTerm('3',$id_student,$date,$_SESSION['email']);
...
if(isset($_POST['sub4'])){
   $date=$_POST['semday4'];
 $count=$db->addnewStudentTerm('4',$id_student,$date,$_SESSION['email']);
...
if(isset($_POST['sub5'])){
   $date=$_POST['semday5'];
 $count=$db->addnewStudentTerm('5',$id_student,$date,$_SESSION['email']);
...
if(isset($_POST['sub6'])){
   $date=$_POST['semday6'];
 $count=$db->addnewStudentTerm('6',$id_student,$date,$_SESSION['email']);
...
if(isset($_POST['sub7'])){
   $date=$_POST['semday7'];
 $count=$db->addnewStudentTerm('7',$id_student,$date,$_SESSION['email']);
...
if(isset($_POST['sub8'])){
   $date=$_POST['semday8'];
 $count=$db->addnewStudentTerm('8',$id_student,$date,$_SESSION['email']);
